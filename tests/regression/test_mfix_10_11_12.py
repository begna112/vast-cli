"""Regression tests for MFIX-10, MFIX-11, MFIX-12 fixes."""
import re
import sys
...
class TestNamingConsistency:
    """MFIX-10: Both workergroup and autogroup names should exist."""
...
class TestTypoFixes:
    """MFIX-12: Response dict should have correct spelling."""
...
class TestAsyncMigration:
    """MFIX-11: _fetch_pubkey should use proper HTTP, not subprocess curl."""
