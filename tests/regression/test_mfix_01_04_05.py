"""Regression tests for MFIX-01, MFIX-04, MFIX-05, MFIX-07 fixes.

MFIX-01: No Python builtins (id, sum) should be shadowed by local variables
MFIX-04: strip('-') should not be used for prefix removal (use startswith + lstrip)
MFIX-05: Error messages should reference correct field name
MFIX-07: Unused variables should be removed
"""
import re
import sys
...
class TestVariableShadowing:
    """MFIX-01: No Python builtins should be shadowed by local variable assignments."""
...
class TestStringMethodFixes:
    """MFIX-04: strip('-') should not be used for prefix removal."""
...
class TestErrorMessages:
    """MFIX-05: Error messages should reference correct field."""
